...
При загрузке страницы лидов скрипт автоматически перехватывает и выводит все запросы к API:

```
============================================================
🔍 Перехвачен запрос: POST https://tilda.ru/projects/submit/leads/
============================================================
...
cookie: registered=yes; deviceid=xcj8EP; PHPSESSID=kmen31b5k7gjafs3b3gm
...
📦 POST Data:
------------------------------------------------------------
act=getleads&projectid=2050405&from=0&to=50
============================================================
```
